...
| Enable using static pass   | Enable if you want to perform the privacyIDEA server request automatically beforehand using the provided static password. Required additional parameter: *static pass* (see below).                                                                                                                                                                                                             |
...
| Static pass                | The static password needed by the option: *Enable using static pass*. Leave it empty to perform the privacyIDEA server request with empty pass (useful in some scenarios).                                                                                                                                                                                                                      |
